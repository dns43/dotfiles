...
export ANDROID_SDK_ROOT=/home/dns43/coursework/OS
export ANDROID_SDK_HOME=/home/dns43/coursework/OS/
export JAVA_HOME=`/usr/lib/jvm/java-1.8.0-openjdk-amd64`
export NDK_PATH="/home/dns43/NDK/bin"

test -r ~/.opam/opam-init/init.sh && . ~/.opam/opam-init/init.sh > /dev/null 2> /dev/null || true

# added by Miniconda3 installer
export PATH="/home/dns43/miniconda3/bin:$PATH"
